...
public class MainActivity extends AppCompatActivity implements ForecastAdapter.ListItemClickListnerInterface {
    ...
    private String[] dataForClickListner;
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            if (weatherData != null) {
                 ...
                 */
                dataForClickListner=weatherData;
...
private Toast mToast;
    ...
    @Override
    public void onClickListner(int clickedItemIndex) {
        if (mToast!=null){
            mToast.cancel();
        }
        String[] fullData=dataForClickListner[clickedItemIndex].split("-");
        String data=fullData[0];
        String toastMessage="This day is coming after"+clickedItemIndex +"Day(s)  form now and it is" +data ;
